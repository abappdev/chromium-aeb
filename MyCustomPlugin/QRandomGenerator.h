...
public:
    ...
    quint32 bounded(quint32 highest)
    {
        ...
        std::uniform_int_distribution<quint32> dist(0, highest - 1);
        return dist(gen);
    }
    ...
    quint32 bounded(quint32 lowest, quint32 highest)
    {
        static std::random_device rd;
        static thread_local std::mt19937 gen(rd());
        std::uniform_int_distribution<quint32> dist(lowest, highest - 1);
        return dist(gen);
    }

    int bounded(int highest)
    {
        return static_cast<int>(bounded(static_cast<quint32>(highest)));
    }

    int bounded(int lowest, int highest)
    {
        return static_cast<int>(bounded(static_cast<quint32>(lowest), static_cast<quint32>(highest)));
    }
    ...
    double bounded(double highest)
    {
        static std::random_device rd;
        static thread_local std::mt19937 gen(rd());
        std::uniform_real_distribution<double> dist(0.0, highest);
        return dist(gen);
    }
